  ...
  void _saveChanges() {
    setState(() {
      _config = _config.copyWith(
        session1Price:
            int.tryParse(_price1Controller.text) ?? _config.session1Price,
        session2Price:
            int.tryParse(_price2Controller.text) ?? _config.session2Price,
        discountPercent:
            int.tryParse(_discountController.text) ?? _config.discountPercent,
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Perubahan Tarif dan Pembayaran berhasil disimpan!'),
      ),
    );
  }
