  ...
  void _confirmManualBooking() {
    if (_formKey.currentState!.validate() && _selectedHours > 0) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Booking Manual untuk ${_nameController.text} (${_selectedHours} jam) berhasil dikonfirmasi!',
          ),
        ),
      );
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Form(key: _formKey, child: _buildCustomerDetailSection()),
      ...
      child: Column(
        ...
        children: [
          Align(
            ...
            child: Chip(
              label: Text(
                _selectedHours == 0 ? '0 Jam' : 'Total Jam: $_selectedHours',
              ),
