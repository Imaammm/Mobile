...
class _AdminScheduleManagementScreenState
          ...
          TextButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    'Booking $id dijadwalkan ulang (Implementasi navigasi ke form reschedule).',
                  ),
                ),
              );
            },
  ...
  void _deleteBooking(String id) {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text('Booking $id berhasil dihapus.')));
  }
          ...
          children: [
            Row(
              ...
              children: [
                ...
                ), // Menggunakan chip status yang sudah ada
              ],
            ),
